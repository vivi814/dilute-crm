...
// 「哪一天」的認定方式是商家明確指定的：用台灣時間（UTC+8）的日期，理由是
// 要跟 SHOPLINE 官方後台首頁「成交總額」的認定方式一致，方便對數字。這表示
// 訂單編號開頭的日期（訂單編號本身是拿 UTC 時間格式化出來的，例如
// 20260728162906346 = UTC 2026-07-28 16:29:06）在深夜下的單這種邊界情況下，
// 會跟這裡算出來的「哪一天」對不起來——這是商家明確選擇要跟官方後台一致，
// 不是算錯，日後如果要改回用訂單編號的 UTC 日期，把 TZ_OFFSET_MS 改回 0 即可。
